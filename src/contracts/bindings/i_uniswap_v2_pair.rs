...
pub mod i_uniswap_v2_pair {
    ...
    pub static IUNISWAPV2PAIR_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IUniswapV2Pair<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IUniswapV2Pair<M> {
        ...
        pub fn get_reserves(
            &self,
        ) -> ::ethers_contract::builders::ContractCall<M, (u128, u128, u32)> {
            self.0
        ...
        pub fn swap(
            &self,
            amount_0_out: ::ethers_core::types::U256,
            amount_1_out: ::ethers_core::types::U256,
            to: ::ethers_core::types::Address,
        ...
        pub fn sync(&self) -> ::ethers_contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn sync_filter(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, SyncFilter> {
            self.0.event()
        }
    ...
    pub struct SwapFilter {
        #[ethevent(indexed)]
        pub sender: ::ethers_core::types::Address,
        pub amount_0_in: ::ethers_core::types::U256,
        pub amount_1_in: ::ethers_core::types::U256,
        pub amount_0_out: ::ethers_core::types::U256,
        pub amount_1_out: ::ethers_core::types::U256,
        #[ethevent(indexed)]
        pub to: ::ethers_core::types::Address,
    }
    #[derive(
    ...
    impl ::ethers_contract::EthLogDecode for IUniswapV2PairEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for IUniswapV2PairCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <MinimumLiquidityCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::MinimumLiquidity(decoded));
            }
            if let Ok(decoded)
                = <PermitTypehashCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <GetReservesCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <KlastCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <Price0CumulativeLastCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::Price0CumulativeLast(decoded));
            }
            if let Ok(decoded)
                = <Price1CumulativeLastCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::Price1CumulativeLast(decoded));
            }
            if let Ok(decoded)
                = <SkimCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <SyncCall as ::ethers_core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers_core::abi::AbiEncode for IUniswapV2PairCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::Klast(element) => ::ethers_core::abi::AbiEncode::encode(element),
    ...
    pub struct MinimumLiquidityReturn(pub ::ethers_core::types::U256);
    ...
    pub struct KlastReturn(pub ::ethers_core::types::U256);
    ...
    pub struct Price0CumulativeLastReturn(pub ::ethers_core::types::U256);
    ...
    pub struct Price1CumulativeLastReturn(pub ::ethers_core::types::U256);
